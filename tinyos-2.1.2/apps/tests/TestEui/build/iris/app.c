...
extern void *memset(void *arg_0x7f2994623020, int arg_0x7f2994623288, size_t arg_0x7f2994623530);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f2994602838, const void *arg_0x7f2994602b10);
...
#line 261
  int size;
  int len;
  int (*put)(char arg_0x7f29944924b0, struct __file *arg_0x7f29944927f0);
  int (*get)(struct __file *arg_0x7f2994491020);
  void *udata;
};
#line 405
struct __file;
...
typedef TMilli TestEuiC__Timer__precision_tag;
...
static void TestEuiC__Boot__booted(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestEuiC__Timer__fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
enum MeasureClockC____nesc_unnamed4327 {
...
# 48 "/opt/tinyos-2.1.2/tos/interfaces/LocalIeeeEui64.nc"
static ieee_eui64_t TestEuiC__LocalIeeeEui64__getId(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void TestEuiC__Leds__led0Toggle(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestEuiC__Timer__startPeriodic(uint32_t dt);
# 53 "TestEuiC.nc"
static inline void TestEuiC__Boot__booted(void );



static inline void TestEuiC__Timer__fired(void );
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm1281AlarmAsyncP*/Atm1281AlarmAsyncP__0____nesc_unnamed4329 {
...
# 48 "/opt/tinyos-2.1.2/tos/interfaces/LocalIeeeEui64.nc"
inline static ieee_eui64_t TestEuiC__LocalIeeeEui64__getId(void ){
#line 48
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void TestEuiC__Leds__led0Toggle(void ){
#line 67
...
#line 57
{
  ...
  TestEuiC__Leds__led0Toggle();

  id = TestEuiC__LocalIeeeEui64__getId();
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f299405d228){
#line 83
  switch (arg_0x7f299405d228) {
#line 83
    case 0U:
#line 83
      TestEuiC__Timer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f299405d228);
#line 83
      break;
#line 83
    }
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TestEuiC__Timer__startPeriodic(uint32_t dt){
#line 64
...
#line 53
{
  TestEuiC__Timer__startPeriodic(1000);
}

# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
inline static void RealMainP__Boot__booted(void ){
#line 60
  TestEuiC__Boot__booted();
#line 60
}
#line 60
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f29944cfab0){
#line 75
  switch (arg_0x7f29944cfab0) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f29944cfab0);
#line 75
      break;
#line 75
    }
