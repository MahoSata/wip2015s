/**
 * TestNetworkC exercises the basic networking layers, colles DemoSensorC at a basic rate
...
implementation {
  ...
  event void RadioControl.startDone(error_t err) {
	...
	call RootControl.setRoot();
      ...
      // 
      // if (TOS_NODE_ID == 3){
      //   call ForceParentInsertion.forceParent(2);
      // }
  ...
  Receive.receive(message_t* msg, void* payload, uint8_t len) {
 	TestNetworkMsg* addMsg = (TestNetworkMsg*)payload;
    ...
    else if (call CollectionPacket.getOrigin(msg) == 2){
	call Leds.led1Toggle();
    }
    else if (call CollectionPacket.getOrigin(msg) == 3){
