...
extern void *memset(void *arg_0x7f06a41dc020, int arg_0x7f06a41dc288, size_t arg_0x7f06a41dc530);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f06a41bb838, const void *arg_0x7f06a41bbb10);
...
#line 261
  int size;
  int len;
  int (*put)(char arg_0x7f06a4039398, struct __file *arg_0x7f06a40396d8);
  int (*get)(struct __file *arg_0x7f06a4039dc8);
  void *udata;
};
#line 405
...
typedef TMilli TestP__Timer__precision_tag;
...
static void TestP__showState_task__runTask(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestP__Timer__fired(void );
...
# 44 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
static unsigned int PlatformLedP__MultiLed__get(void );


static void PlatformLedP__MultiLed__set(unsigned int val);
...
# 44 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
static unsigned int TestP__MultiLed__get(void );


static void TestP__MultiLed__set(unsigned int val);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t TestP__showState_task__postTask(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestP__Timer__startPeriodic(uint32_t dt);
# 59 "TestP.nc"
enum TestP____nesc_unnamed4323 {
#line 59
  TestP__showState_task = 0U
};
#line 59
typedef int TestP____nesc_sillytask_showState_task[TestP__showState_task];
#line 56
unsigned int TestP__last_set;
unsigned int TestP__counter;

static inline void TestP__showState_task__runTask(void );
...
static inline void TestP__Timer__fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm1281AlarmAsyncP*/Atm1281AlarmAsyncP__0____nesc_unnamed4326 {
...
static uint8_t PlatformLedP__Leds__get(void );
#line 134
static void PlatformLedP__Leds__set(uint8_t val);
# 83 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
static inline unsigned int PlatformLedP__MultiLed__get(void );

static inline void PlatformLedP__MultiLed__set(unsigned int val);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/UartByte.nc"
...
enum /*CounterMicro32C.Transform32*/TransformCounterC__0____nesc_unnamed4331 {
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t TestP__showState_task__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(TestP__showState_task);
#line 67
...
inline static void PlatformLedP__Leds__set(uint8_t val){
#line 134
  LedsP__Leds__set(val);
#line 134
}
#line 134
# 85 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
static inline void PlatformLedP__MultiLed__set(unsigned int val)
#line 85
{
#line 85
...
# 47 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
inline static void TestP__MultiLed__set(unsigned int val){
#line 47
  PlatformLedP__MultiLed__set(val);
#line 47
}
#line 47
# 69 "TestP.nc"
...
#line 69
{
  TestP__last_set = ++TestP__counter;
  TestP__MultiLed__set(TestP__last_set);
  TestP__showState_task__postTask();
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f06a3cbcda0){
#line 83
  switch (arg_0x7f06a3cbcda0) {
#line 83
    case 0U:
#line 83
      TestP__Timer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f06a3cbcda0);
#line 83
      break;
#line 83
    }
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TestP__Timer__startPeriodic(uint32_t dt){
#line 64
...
{
  TestP__counter = 0;
  TestP__Timer__startPeriodic(512);
}
...
#line 60
# 117 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static uint8_t PlatformLedP__Leds__get(void ){
#line 117
  unsigned char __nesc_result;
#line 117
...
{
#line 83
  return PlatformLedP__Leds__get();
}

# 44 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
inline static unsigned int TestP__MultiLed__get(void ){
#line 44
  unsigned int __nesc_result;
#line 44

#line 44
  __nesc_result = PlatformLedP__MultiLed__get();
#line 44
...
static inline void TestP__showState_task__runTask(void )
{
  printf("count=%04x, led=%04x\r\n", TestP__last_set, TestP__MultiLed__get());
}
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f06a4088ab0){
#line 75
  switch (arg_0x7f06a4088ab0) {
#line 75
    case TestP__showState_task:
#line 75
      TestP__showState_task__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f06a4088ab0);
#line 75
      break;
#line 75
    }
