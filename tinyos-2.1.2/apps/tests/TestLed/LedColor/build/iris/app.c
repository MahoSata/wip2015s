...
extern void *memset(void *arg_0x7f9e6b0cb020, int arg_0x7f9e6b0cb288, size_t arg_0x7f9e6b0cb530);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f9e6b0aa838, const void *arg_0x7f9e6b0aab10);
...
#line 261
  int size;
  int len;
  int (*put)(char arg_0x7f9e6af28398, struct __file *arg_0x7f9e6af286d8);
  int (*get)(struct __file *arg_0x7f9e6af28dc8);
  void *udata;
};
#line 405
...
static void TestP__showColor_task__runTask(void );
...
# 43 "/opt/tinyos-2.1.2/tos/interfaces/Led.nc"
static void TestP__Yellow__on(void );
#line 43
static void TestP__Green__on(void );
# 47 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
static void TestP__MultiLed__set(unsigned int val);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t TestP__showColor_task__postTask(void );
# 43 "/opt/tinyos-2.1.2/tos/interfaces/Led.nc"
static void TestP__Red__on(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestP__Timer__startOneShot(uint32_t dt);
# 88 "TestP.nc"
enum TestP____nesc_unnamed4323 {
#line 88
  TestP__showColor_task = 0U
};
#line 88
typedef int TestP____nesc_sillytask_showColor_task[TestP__showColor_task];
#line 72
enum TestP____nesc_unnamed4324 {
  TestP__LC_Red, 
  TestP__LC_Orange, 
  TestP__LC_Yellow, 
  TestP__LC_Green, 
...
enum TestP____nesc_unnamed4325 {
  TestP__TIMER_DELAY_BMS = 2048
};

unsigned int TestP__color_index;
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm1281AlarmAsyncP*/Atm1281AlarmAsyncP__0____nesc_unnamed4328 {
...
# 47 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t TestP__showColor_task__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(TestP__showColor_task);
#line 67
...
#line 145
{
  TestP__showColor_task__postTask();
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f9e6aba1da0){
#line 83
  switch (arg_0x7f9e6aba1da0) {
#line 83
    case 0U:
#line 83
      TestP__Timer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f9e6aba1da0);
#line 83
      break;
#line 83
    }
...
#line 47
# 43 "/opt/tinyos-2.1.2/tos/interfaces/Led.nc"
inline static void TestP__Red__on(void ){
#line 43
...
#line 89
# 43 "/opt/tinyos-2.1.2/tos/interfaces/Led.nc"
inline static void TestP__Yellow__on(void ){
#line 43
  PlatformLedP__Led__on(2);
#line 43
}
#line 43
inline static void TestP__Green__on(void ){
#line 43
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TestP__Timer__startOneShot(uint32_t dt){
#line 73
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f9e6af77ab0){
#line 75
  switch (arg_0x7f9e6af77ab0) {
#line 75
    case TestP__showColor_task:
#line 75
      TestP__showColor_task__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f9e6af77ab0);
#line 75
      break;
#line 75
    }
...
static void TestP__showColor_task__runTask(void )
{
  int delay = TestP__TIMER_DELAY_BMS;

#line 91
  TestP__MultiLed__set(0);
  switch (TestP__color_index) {
      ...
      case TestP__LC_Yellow: 
        TestP__Yellow__on();
      printf("Yellow\r\n");
      break;


      case TestP__LC_Green: 
        TestP__Green__on();
      printf("Green\r\n");
      break;
#line 129
  ...
  if (++TestP__color_index == TestP__LC_LIMIT) {
      TestP__color_index = 0;
    }
  TestP__Timer__startOneShot(delay);
}
