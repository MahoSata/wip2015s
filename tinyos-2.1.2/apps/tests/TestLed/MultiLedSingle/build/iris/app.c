...
extern void *memset(void *arg_0x7f63adf9a020, int arg_0x7f63adf9a288, size_t arg_0x7f63adf9a530);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f63adf79838, const void *arg_0x7f63adf79b10);
...
typedef TMilli TestP__Timer3__precision_tag;
typedef TMilli TestP__Timer1__precision_tag;
typedef TMilli TestP__Timer4__precision_tag;
typedef TMilli TestP__Timer2__precision_tag;
typedef TMilli TestP__Timer5__precision_tag;
...
static void TestP__Timer3__fired(void );
#line 83
static void TestP__Timer1__fired(void );
#line 83
static void TestP__Timer4__fired(void );
#line 83
static void TestP__Timer2__fired(void );
#line 83
static void TestP__Timer5__fired(void );
...
# 64 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
static void PlatformLedP__MultiLed__toggle(unsigned int led_id);
# 53 "/opt/tinyos-2.1.2/tos/interfaces/Led.nc"
static void PlatformLedP__Led__toggle(
# 40 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
uint8_t arg_0x7f63ad9e9350);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestP__Timer3__startPeriodic(uint32_t dt);
# 64 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
static void TestP__MultiLed__toggle(unsigned int led_id);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TestP__Timer1__startPeriodic(uint32_t dt);
#line 64
static void TestP__Timer4__startPeriodic(uint32_t dt);
#line 64
static void TestP__Timer2__startPeriodic(uint32_t dt);
#line 64
static void TestP__Timer5__startPeriodic(uint32_t dt);
# 54 "TestP.nc"
...
static inline void TestP__Timer1__fired(void );



static inline void TestP__Timer2__fired(void );



static inline void TestP__Timer3__fired(void );



static inline void TestP__Timer4__fired(void );



static inline void TestP__Timer5__fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 74 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
static void PlatformLedP__Led__toggle(uint8_t led_id);
#line 93
static inline void PlatformLedP__MultiLed__toggle(unsigned int led_id);
...
#line 78
# 93 "/opt/tinyos-2.1.2/tos/platforms/iris/PlatformLedP.nc"
static inline void PlatformLedP__MultiLed__toggle(unsigned int led_id)
#line 93
{
#line 93
  PlatformLedP__Led__toggle(led_id);
}

# 64 "/opt/tinyos-2.1.2/tos/interfaces/MultiLed.nc"
inline static void TestP__MultiLed__toggle(unsigned int led_id){
#line 64
  PlatformLedP__MultiLed__toggle(led_id);
#line 64
}
#line 64
# 62 "TestP.nc"
...
#line 62
{
  TestP__MultiLed__toggle(0);
}

static inline void TestP__Timer2__fired(void )
#line 66
{
  TestP__MultiLed__toggle(1);
}

static inline void TestP__Timer3__fired(void )
#line 70
{
  TestP__MultiLed__toggle(2);
}

static inline void TestP__Timer4__fired(void )
#line 74
{
  TestP__MultiLed__toggle(3);
}

static inline void TestP__Timer5__fired(void )
#line 78
{
  TestP__MultiLed__toggle(4);
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f63adab1da0){
#line 83
  switch (arg_0x7f63adab1da0) {
#line 83
    case 0U:
#line 83
      TestP__Timer1__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      TestP__Timer2__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      TestP__Timer3__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      TestP__Timer4__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      TestP__Timer5__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f63adab1da0);
#line 83
      break;
#line 83
    }
...
#line 62
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TestP__Timer1__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(0U, dt);
#line 64
}
#line 64
inline static void TestP__Timer2__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(1U, dt);
#line 64
}
#line 64
inline static void TestP__Timer3__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(2U, dt);
#line 64
}
#line 64
inline static void TestP__Timer4__startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startPeriodic(3U, dt);
#line 64
}
#line 64
inline static void TestP__Timer5__startPeriodic(uint32_t dt){
#line 64
...
#line 54
{
  TestP__Timer5__startPeriodic(4096);
  TestP__Timer4__startPeriodic(2048);
  TestP__Timer3__startPeriodic(1024);
  TestP__Timer2__startPeriodic(512);
  TestP__Timer1__startPeriodic(256);
}
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f63ade46ab0){
#line 75
  switch (arg_0x7f63ade46ab0) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f63ade46ab0);
#line 75
      break;
#line 75
    }
