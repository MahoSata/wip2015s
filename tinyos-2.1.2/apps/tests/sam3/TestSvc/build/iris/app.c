...
extern void *memset(void *arg_0x7f8e36c58020, int arg_0x7f8e36c58288, size_t arg_0x7f8e36c58530);
...
typedef int (*__compar_fn_t)(const void *arg_0x7f8e36c37838, const void *arg_0x7f8e36c37b10);
...
static void TestSvcC__Boot__booted(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 46 "TestSvcC.nc"
static inline error_t TestSvcC__syscall(uint8_t id, uint32_t p0, uint32_t p1, uint32_t p2, uint32_t p3);
#line 64
static inline void TestSvcC__Boot__booted(void );
...
void ActualSVCallHandler(uint32_t *args)   ;
#line 94
void SVCallHandler(void )   __attribute((naked)) ;
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
static inline error_t TestSvcC__syscall(uint8_t id, uint32_t p0, uint32_t p1, uint32_t p2, uint32_t p3)
{
  volatile uint32_t result;
   ...
   __asm volatile ("mov r0, %0" :  : "r"(p0));
   __asm volatile ("mov r1, %0" :  : "r"(p1));
   __asm volatile ("mov r2, %0" :  : "r"(p2));
   __asm volatile ("mov r3, %0" :  : "r"(p3));
   __asm volatile ("svc %0" :  : "i"(id));
...
static inline void TestSvcC__Boot__booted(void )
{
  volatile uint32_t result = TestSvcC__syscall(0x42, 0x00, 0x11, 0x22, 0x33);
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f8e36b04ab0){
#line 75
    SchedulerBasicP__TaskBasic__default__runTask(arg_0x7f8e36b04ab0);
#line 75
}
#line 75
  ...
  void ActualSVCallHandler(uint32_t *args)
{
  ...
  __attribute((naked)) void SVCallHandler(void )
{
   __asm volatile (
  "tst lr, #4\n"
  "ite eq\n"
